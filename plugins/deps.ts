...
export * from "https://cdn.jsdelivr.net/gh/ckoshka/workerlib/mod.ts";
export * from "https://cdn.skypack.dev/-/msgpackr@v1.7.0-beta1-D6AQjTILhzJzG8i0TwC6/dist=es2019,mode=imports/optimized/msgpackr.js";
export { fast1a32 } from "https://cdn.skypack.dev/fnv-plus@1.3.1";
export { readLines } from "https://deno.land/std@0.160.0/io/mod.ts";
export * from "https://deno.land/std@0.160.0/streams/delimiter.ts";
export * from "https://deno.land/std@0.160.0/streams/mod.ts";
