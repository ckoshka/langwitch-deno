import { BaseContext, Concept, Free, int, State, adjust } from "../../deps.ts";
...
const sortContexts1 = (state: State) =>
	(ctxs: BaseContext[]) => {
...
export const randomise = (newCtxs: BaseContext[], oldCtxs: (readonly [BaseContext, number])[]) => {
