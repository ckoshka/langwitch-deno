...
const filepath = await unZipFromURL(`https://github.com/ckoshka/minimal.rs/releases/download/v0.1.1/minimal.rs_v0.1.1_x86_64-apple-darwin.zip`);
await implCommandOutput.runCmds([
    `mv ${filepath} langwitch-home/binaries/minimal`
]);
